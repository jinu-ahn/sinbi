package c104.sinbisecurity.config;

import c104.sinbisecurity.filter.*;
import c104.sinbisecurity.util.CookieUtil;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .addFilterBefore(new JwtExceptionFilter(tokenProvider, cookieUtil), AuthenticationFilter.class)
                // 예외 처리 설정
                .exceptionHandling(e -> {
