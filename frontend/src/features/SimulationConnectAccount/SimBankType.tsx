...
const SimBankType: React.FC = () => {
  const { bankType, setBankType, error, setError } =
    ...
    <div>
      ...
      <div className="mt-4 flex w-full justify-center">
        <YellowBox>
          ...
          <div className="grid max-h-[220px] grid-cols-3 gap-4 overflow-y-auto">
            {banks.map((bank) => (
              <div
                key={bank.id}
